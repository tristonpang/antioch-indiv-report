...
FieldIds = Enum('FieldIds', [('respondent', 'Wz6EJ0SrP537'), ('email', 'mQQ6n4XODVE8'), ('role', '7rGpb91gC5Zv'), ('church', '4yBh92Cyp8hz')])
  ...
  def __init__(self, raw_response):
      ...
      for answer in raw_response['answers']:
          try:
              ...
              args_for_answers[field_name] = answer['text'] if answer['type'] == 'text' else answer['email']
          except:
              continue
